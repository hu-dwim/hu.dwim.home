                    ...
                    (make-value-inspector
                     (book (:title "dwim.hu")
                       (chapter (:title "About us")
                         ...
                         (paragraph ()
                           "Our main focus is on Web based business application development, including the expertise needed to evaluate and model complex business processes. But our backgrounds -- besides computer science of course -- covers other fields like physics, electrical engineering and economics. Because of this we, as a team, approach problems with the unique point of view and flexibility of a polyhistor.")
                         (paragraph ()
                       ...
                       (chapter (:title "About this site")
                         ...
                         (paragraph ()
                           "Unfortunately, or maybe fortunately, we don't have much time to work on this site itself, so the content you can find here is not of the quality we are happy with, but it can give you an idea what is possible using our framework. And as we provide a complete installation guide, and because everything here is based on open source software components, interested software developers can install a copy of this site on their own computers and use it as a starting point for their own applications."))
                       #+nil
