...
(def entry-point (*home-application* :path-prefix "file/" :ensure-session #t :ensure-frame #t) ()
  (if (root-component-of *frame*)
      (make-root-component-rendering-response *frame*)
      (bind ((pathname (truename (system-relative-pathname :hu.dwim.home (string+ "../" *entry-point-relative-path*)))))
        (when (starts-with-subseq (namestring common-lisp-user::*workspace-directory*) (namestring pathname))
          (setf (root-component-of *frame*)
